...
ggplot(data = freqCasualties) +
  geom_bar(stat = 'identity', aes(x = class, y = n, fill = gender))
...
ggplot()+
  geom_bar(data = dt, aes(x = College, y = ..prop.., fill = Sex, group = Sex), position = 'fill')
...
ggplot(data =dt) +
 geom_bar(aes(x = Ethnicity, fill = Sex)) +       #plot a count of students in each
  facet_wrap(Sex ~ College, scales = 'free') +
